...
# los archivos no se están copiando  files 
# si llegan tmp, pero nno a files
dbutils.fs.ls("dbfs:/Volumes/integration_catalog9/raw_files/files/")


# COMMAND ----------

spark.sql("SHOW CATALOGS").show()
spark.sql("SHOW SCHEMAS IN integration_catalog9").show()
spark.sql("SHOW VOLUMES IN integration_catalog9.raw_files").show()
